    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('daily_courier_limit')->numeric()->sortable()->toggleable(),
                Tables\Columns\TextColumn::make('monthly_courier_limit')->numeric()->sortable()->toggleable(),
                Tables\Columns\TextColumn::make('monthly_incomplete_order_limit')->numeric()->sortable()->toggleable(),
                Tables\Columns\TextColumn::make('subscriptions_count')->label('Subscribers')->numeric()->sortable(),
            ])
            ->filters([
                //
            ])
            ->actions([
                ...
                // *** মূল পরিবর্তন: "Set as Default" বাটনটি আবার যোগ করা হয়েছে ***
