        ...
        return $table
            ->columns([
                ...
                Tables\Columns\SelectColumn::make('subscription.plan_id')
                    ...
                    // এই ফাংশনটি এখন খালি রিকোয়েস্ট গ্রহণ করবে না
                    ->updateStateUsing(function ($record, $state) {
                        if (blank($state)) {
                            return; // যদি কোনো প্ল্যান সিলেক্ট না করা হয়, তাহলে কিছুই করবে না
                        }
                    ...
                    ->sortable(query: function (Builder $query, string $direction): Builder {
                        return $query->orderBy(Plan::select('name')->whereColumn('plans.id', 'subscriptions.plan_id'), $direction);
                    }),

                Tables\Columns\TextColumn::make('websites_count')->label('Websites')->numeric()->sortable(),
